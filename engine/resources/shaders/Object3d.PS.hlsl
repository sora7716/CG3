...
//点光源
float32_t3 PointLighing(VertexShaderOutput input, float32_t4 textureColor, float32_t3 toEye) {
    //ライティング
    Lighting result;
...
float32_t3 SetLightingMode(VertexShaderOutput input, float32_t4 textureColor, float32_t3 toEye) {
    ...
    //点光源
    float32_t3 pointLighting = PointLighing(input, textureColor, toEye);
